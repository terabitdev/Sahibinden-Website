...
import CreditoneColumnOne from "./CreditoneColumnOne";
import CreditoneColumnThree from "./CreditoneColumnThree";
import CreditoneColumnTwo from "./CreditoneColumnTwo";
import React from "react";
export default function CreditOnePage() {
  const [searchBarValue142, setSearchBarValue142] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[94px] bg-white md:gap-[70px] sm:gap-[47px]">
          ...
          <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
            ...
            <div className="flex w-[46%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue142}
                onChange={(e) => setSearchBarValue142(e.target.value)}
                suffix={
                  searchBarValue142?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue142("")} />
                  ) : null
                }
        ...
        <div>
          {" "}
          <CreditoneColumnOne /> <CreditoneColumnTwo /> <CreditoneColumnThree />{" "}
        </div>{" "}
