...
export default function ZerovehicleworldfindanauthorizedColumn() {
  return (
    <div className="flex flex-col items-center self-stretch">
      {" "}
      <div className="container-sm flex flex-col items-start gap-14 px-[38px] md:px-5 sm:gap-7">
        {" "}
        <Heading
          size="heading3xl"
          as="h2"
        ...
        <div className="self-stretch rounded-[30px] bg-white p-[38px] sm:p-5">
          ...
          <TextArea
            ...
            className="mt-3 rounded-[10px] px-[34px] font-medium capitalize text-text_light sm:px-5 sm:pt-5"
          />{" "}
          <div className="mt-[22px] flex flex-col items-center gap-[50px]">
            {" "}
