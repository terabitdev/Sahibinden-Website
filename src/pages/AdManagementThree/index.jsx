...
const accordionData = [
  { clickfor: "click for Detailed Search" },
  { clickfor: "no transactions found" },
];
const accordionData1 = [
  { advertisements1: "Advertisements" },
  { advertisements1: "Auto Expertise" },
];
export default function AdManagementThreePage() {
  return (
    <>
      {" "}
      <Helmet>
