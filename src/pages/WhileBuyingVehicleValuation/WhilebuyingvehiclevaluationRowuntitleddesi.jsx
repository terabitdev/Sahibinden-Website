...
export default function WhilebuyingvehiclevaluationRowuntitleddesi() {
  const [searchBarValue200, setSearchBarValue200] = React.useState("");
  return (
    <div className="flex items-center gap-[50px] self-stretch md:flex-col">
      ...
      <div className="flex flex-1 items-center justify-between gap-5 md:flex-col md:self-stretch md:px-5">
        ...
        <Input
          ...
          value={searchBarValue200}
          onChange={(e) => setSearchBarValue200(e.target.value)}
          suffix={
            searchBarValue200?.length > 0 ? (
              <CloseSVG onClick={() => setSearchBarValue200("")} />
            ) : null
          }
