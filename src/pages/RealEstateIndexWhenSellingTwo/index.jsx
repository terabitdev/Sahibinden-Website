...
import RealestateindexwhensellingtwoColumnFour from "./RealestateindexwhensellingtwoColumnFour";
...
export default function RealEstateIndexWhenSellingTwoPage() {
  const [searchBarValue164, setSearchBarValue164] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[90px] bg-white md:gap-[67px] sm:gap-[45px]">
          ...
          <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
            ...
            <div className="flex w-[46%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue164}
                onChange={(e) => setSearchBarValue164(e.target.value)}
                suffix={
                  searchBarValue164?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue164("")} />
                  ) : null
                }
        ...
        <div className="flex flex-col gap-[116px] md:gap-[87px] sm:gap-[58px]">
          ...
          <RealestateindexwhensellingtwoColumnFour />{" "}
        </div>{" "}
