...
export default function ServicesoneRowOne() {
  const [searchBarValue463, setSearchBarValue463] = React.useState("");
  return (
          ...
          <div className="relative z-[1] mt-[60px] flex flex-1 flex-col gap-4 md:self-stretch">
            ...
            <div className="flex justify-center gap-4 rounded bg-white p-6 shadow-xs md:flex-col sm:p-5">
              ...
              <Input
                ...
                name="search"
                placeholder={`Search`}
                value={searchBarValue463}
                onChange={(e) => setSearchBarValue463(e.target.value)}
                prefix={
                  <Img
                ...
                suffix={
                  searchBarValue463?.length > 0 ? (
                    <CloseSVG
                      onClick={() => setSearchBarValue463("")}
                      width={24}
                      fillColor="#888f9fff"
                    />
                  ) : null
                }
                className="flex-grow gap-4 rounded border border-solid border-blue_gray-400_03 px-6 font-opensans !text-blue_gray-400_03 shadow-bs md:px-5"
              />
              <SelectBox
                size="md"
                indicator={
                ...
                className="w-[32%] gap-[26px] rounded border border-solid border-blue_gray-400_03 px-6 font-opensans !text-blue_gray-400_03 shadow-bs md:w-full md:px-5"
              />{" "}
              <Button
