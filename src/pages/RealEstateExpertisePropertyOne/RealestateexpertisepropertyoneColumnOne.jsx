...
export default function RealestateexpertisepropertyoneColumnOne() {
  return (
    <div className="flex flex-col items-center">
      {" "}
      <div className="container-sm flex flex-col items-start gap-14 px-[34px] md:px-5 sm:gap-7">
        {" "}
        <Heading
          size="heading3xl"
          as="h2"
          className="ml-3 text-[28px] font-bold capitalize !text-text md:ml-0 md:text-[26px] sm:text-[24px]"
        >
          {" "}
          Leave a Reply{" "}
        </Heading>{" "}
        <div className="ml-3 flex flex-col gap-3 self-stretch rounded-[30px] bg-white p-[38px] md:ml-0 sm:p-5">
          {" "}
