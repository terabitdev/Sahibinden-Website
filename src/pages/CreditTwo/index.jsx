...
import CredittwoColumnOne from "./CredittwoColumnOne";
import CredittwoColumnThree from "./CredittwoColumnThree";
import CredittwoColumnTwo from "./CredittwoColumnTwo";
import React from "react";
export default function CreditTwoPage() {
  const [searchBarValue160, setSearchBarValue160] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[94px] bg-white md:gap-[70px] sm:gap-[47px]">
          ...
          <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
            ...
            <div className="flex w-[46%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue160}
                onChange={(e) => setSearchBarValue160(e.target.value)}
                suffix={
                  searchBarValue160?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue160("")} />
                  ) : null
                }
        ...
        <div>
          {" "}
          <CredittwoColumnOne /> <CredittwoColumnTwo /> <CredittwoColumnThree />{" "}
        </div>{" "}
