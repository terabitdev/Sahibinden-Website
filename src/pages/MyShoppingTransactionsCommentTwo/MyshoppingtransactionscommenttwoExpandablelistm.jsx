...
const accordionData = [
  { mymoneyis19: "My Money is Safe" },
  { mymoneyis19: "Comment Management" },
  { mymoneyis19: "Brand New Transactions" },
  { mymoneyis19: "Safe E-Commerce" },
];
export default function MyshoppingtransactionscommenttwoExpandablelistm() {
  return (
