...
import MyshoppingtransactionswhatColumn from "./MyshoppingtransactionswhatColumn";
...
const accordionData = [
  { mymoneyis6: "My Money is Safe" },
  { mymoneyis6: "Brand New Transactions" },
  { mymoneyis6: "What I sold with brand new" },
  { mymoneyis6: "Safe E-Commerce" },
];
export default function MyShoppingTransactionsWhatPage() {
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[92px] bg-white md:gap-[69px] sm:gap-[46px]">
        ...
        <div className="flex flex-col items-center gap-[100px] md:gap-[75px] sm:gap-[50px]">
                                    ...
                                    <div className="flex justify-between gap-5 border border-solid border-primary_colors-900 bg-white px-5 py-4">
                                      ...
                                      >
                                        ...
                                        <Text
                                          size="textlg"
                                          as="p"
                                          className="w-[78%] text-[15px] font-normal leading-[22px]"
                                        >
                                          {" "}
                                          {d.mymoneyis6}{" "}
                                        </Text>{" "}
                ...
                <div className="flex flex-col items-center justify-center gap-5 self-stretch rounded-[10px] bg-white px-14 py-[126px] shadow-xs md:p-5">
                  ...
                  >
                    ...
                    <span className="text-black-900_01">
                      ...
                      <>
                        {" "}
                        You do not have a device you purchased <br />{" "}
                      </>{" "}
                    </span>{" "}
                    <span className="text-blue_gray-400_03">
                      {" "}
                      You can view the devices you will purchase with Yepy on
                      this page.{" "}
                    </span>{" "}
                  </Heading>{" "}
                  <Button
          ...
          <MyshoppingtransactionswhatColumn />{" "}
        </div>{" "}
