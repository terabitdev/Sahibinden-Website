...
import MyshoppingtransactionsmydeliveryoneColumn from "./MyshoppingtransactionsmydeliveryoneColumn";
...
const accordionData = [
  { mymoneyis2: "My Money is Safe" },
  { mymoneyis2: "Brand New Transactions" },
  { mymoneyis2: "Safe E-Commerce" },
  { mymoneyis2: "Summary" },
  { mymoneyis2: "My Orders" },
  { mymoneyis2: "My Sales Transaction" },
  { mymoneyis2: "My Product on Sale" },
  { mymoneyis2: "What i will ship" },
  { mymoneyis2: "approval from the buyer" },
  { mymoneyis2: "My Successful Sales" },
  { mymoneyis2: "Returns & Cancellation" },
  { mymoneyis2: "My Products that are not on sale" },
  { mymoneyis2: "My Head office address" },
  { mymoneyis2: "My Distance Contracts" },
  { mymoneyis2: "My delivery / billing addresses" },
  { mymoneyis2: "Comment Management" },
];
export default function MyShoppingTransactionsMydeliveryOnePage() {
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[92px] bg-white md:gap-[69px] sm:gap-[46px]">
        ...
        <div className="flex flex-col items-center gap-[94px] md:gap-[70px] sm:gap-[47px]">
          ...
          <MyshoppingtransactionsmydeliveryoneColumn />{" "}
        </div>{" "}
