...
import WhilesellingvehiclesalesguideColumnOne from "./WhilesellingvehiclesalesguideColumnOne";
import WhilesellingvehiclesalesguideRowFour from "./WhilesellingvehiclesalesguideRowFour";
import WhilesellingvehiclesalesguideRowTwo from "./WhilesellingvehiclesalesguideRowTwo";
import React from "react";
export default function WhileSellingVehicleSalesGuidePage() {
  const [searchBarValue89, setSearchBarValue89] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="w-full bg-white">
          ...
          <div className="flex items-center justify-center gap-[50px] self-stretch md:flex-col">
            ...
            <div className="flex w-[86%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue89}
                onChange={(e) => setSearchBarValue89(e.target.value)}
                suffix={
                  searchBarValue89?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue89("")} />
                  ) : null
                }
        ...
        <div className="mt-1 flex flex-col items-center gap-[58px] sm:gap-[29px]">
          {" "}
          <div className="container-sm flex flex-col items-start pl-[460px] pr-14 md:px-5">
            {" "}
          ...
          <div className="self-stretch">
            {" "}
            <WhilesellingvehiclesalesguideRowTwo />{" "}
            <WhilesellingvehiclesalesguideRowFour />{" "}
            <WhilesellingvehiclesalesguideColumnOne />{" "}
          </div>{" "}
        </div>{" "}
