...
import WhilesellingvehiclesalesguidetwoColumn from "./WhilesellingvehiclesalesguidetwoColumn";
import WhilesellingvehiclesalesguidetwoRowOne from "./WhilesellingvehiclesalesguidetwoRowOne";
import React from "react";
export default function WhileSellingVehicleSalesGuideTwoPage() {
  const [searchBarValue93, setSearchBarValue93] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[82px] bg-white md:gap-[61px] sm:gap-[41px]">
          ...
          <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
            ...
            <div className="flex w-[46%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue93}
                onChange={(e) => setSearchBarValue93(e.target.value)}
                suffix={
                  searchBarValue93?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue93("")} />
                  ) : null
                }
        ...
        <div className="flex flex-col gap-[98px] md:gap-[73px] sm:gap-[49px]">
          {" "}
          <WhilesellingvehiclesalesguidetwoRowOne />{" "}
          <WhilesellingvehiclesalesguidetwoColumn />{" "}
        </div>{" "}
