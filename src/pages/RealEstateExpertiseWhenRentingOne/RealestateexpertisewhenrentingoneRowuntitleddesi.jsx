...
export default function RealestateexpertisewhenrentingoneRowuntitleddesi() {
  const [searchBarValue411, setSearchBarValue411] = React.useState("");
  return (
    <div className="flex items-center gap-[50px] self-stretch md:flex-col">
      ...
      <div className="flex flex-1 items-center justify-between gap-5 md:flex-col md:self-stretch md:px-5">
        ...
        <Input
          ...
          value={searchBarValue411}
          onChange={(e) => setSearchBarValue411(e.target.value)}
          suffix={
            searchBarValue411?.length > 0 ? (
              <CloseSVG onClick={() => setSearchBarValue411("")} />
            ) : null
          }
