...
import MyaccountmypersonalinformationoneColumnOne from "./MyaccountmypersonalinformationoneColumnOne";
...
const accordionData = [
  { myaccountOne1: "My Account Information" },
  { myaccountOne1: "Security" },
  { myaccountOne1: "My Permissions" },
];
export default function MyAccountMyPersonalInformationOnePage() {
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[82px] bg-white md:gap-[61px] sm:gap-[41px]">
        ...
        <div className="flex flex-col items-center gap-[136px] md:gap-[102px] sm:gap-[68px]">
              ...
              <div className="flex flex-1 flex-col items-start gap-6 self-center md:self-stretch">
                ...
                <div className="flex flex-col items-center justify-center gap-5 self-stretch rounded-[10px] bg-white px-[26px] py-16 shadow-xs md:py-5 sm:p-5">
                  ...
                  <div className="flex flex-col gap-5 self-stretch">
                    ...
                    <div className="flex items-center justify-center gap-[30px] md:flex-col">
                      ...
                      <div className="flex flex-1 gap-9 md:flex-col md:self-stretch">
                        {" "}
                        <Input
                          size="2xl"
                          shape="round"
                          name="test"
                          placeholder={`Test`}
                          className="w-full rounded-[10px] border border-solid border-primary_colors-900 px-2.5 capitalize !text-black-0"
                        />{" "}
                        <Input
                          size="2xl"
                          shape="round"
                ...
                <div className="flex justify-end gap-[21px] self-stretch">
                  ...
                  <Button
                    ...
                    variant="fill"
                    shape="round"
                    className="min-w-[124px] rounded-[24px] border border-solid border-primary_colors-900 px-[31px] font-medium uppercase !text-primary_colors-900 sm:px-5"
                  >
                    {" "}
                    Give up{" "}
                  </Button>{" "}
          ...
          <MyaccountmypersonalinformationoneColumnOne />{" "}
        </div>{" "}
