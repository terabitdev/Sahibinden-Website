...
const accordionData = [
  { myaccountOne9: "My Account Information" },
  { myaccountOne9: "Security" },
  { myaccountOne9: "My Permissions" },
];
export default function MyAccountAccountHoldersPage() {
  return (
    <>
      {" "}
      <Helmet>
          ...
          <div>
            <div className="flex flex-col gap-[100px] md:gap-[75px] sm:gap-[50px]">
              ...
              <div className="flex items-start gap-[30px] md:flex-col">
                        ...
                        <AccordionItemPanel>
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <Text
                              size="text2xl"
                              as="p"
                              className="relative z-[1] border border-solid border-primary_colors-900 bg-white py-3 pl-5 pr-[34px] text-[18.64px] font-normal !text-primary_colors-900 sm:pr-5"
                            >
                              {" "}
                ...
                <div className="flex flex-1 flex-col items-center gap-5 md:self-stretch">
                  {" "}
                  <Breadcrumb
                    separator={
                      <Text className="h-[38px] w-[10.61px] text-[25px] font-normal !text-colors md:text-[23px] sm:text-[21px]">
                        {" "}
                        /{" "}
                      </Text>
                    }
                    className="flex flex-wrap gap-[86px] self-stretch md:gap-5"
                  >
                    {" "}
                    <BreadcrumbItem>
                      {" "}
                  ...
                  <Heading
                    size="text3xl"
                    as="h3"
                    className="text-shadow-ts1 rounded-[10px] bg-white pb-[30px] pl-6 pr-[34px] pt-6 text-[20px] font-normal capitalize sm:p-5"
                  >
                    {" "}
