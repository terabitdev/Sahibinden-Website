...
export default function ServicesRowOne() {
  const [searchBarValue460, setSearchBarValue460] = React.useState("");
  return (
          ...
          <div className="relative z-[1] mt-[60px] flex flex-1 flex-col gap-4 md:self-stretch">
            ...
            <div className="flex justify-center gap-4 rounded bg-white p-6 shadow-xs md:flex-col sm:p-5">
              ...
              <Input
                ...
                name="search"
                placeholder={`Search`}
                value={searchBarValue460}
                onChange={(e) => setSearchBarValue460(e.target.value)}
                prefix={
                  <Img
                ...
                suffix={
                  searchBarValue460?.length > 0 ? (
                    <CloseSVG
                      onClick={() => setSearchBarValue460("")}
                      width={24}
                      fillColor="#888f9fff"
                    />
                  ) : null
