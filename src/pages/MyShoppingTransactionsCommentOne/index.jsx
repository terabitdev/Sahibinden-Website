...
import MyshoppingtransactionscommentoneColumn from "./MyshoppingtransactionscommentoneColumn";
import MyshoppingtransactionscommentoneExpandablelistm from "./MyshoppingtransactionscommentoneExpandablelistm";
...
export default function MyShoppingTransactionsCommentOnePage() {
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[82px] bg-white md:gap-[61px] sm:gap-[41px]">
        ...
        <div className="flex flex-col gap-[98px] md:gap-[73px] sm:gap-[49px]">
          ...
          <div className="flex items-start justify-center gap-[30px] md:flex-col">
            {" "}
            <MyshoppingtransactionscommentoneExpandablelistm />{" "}
          ...
          <MyshoppingtransactionscommentoneColumn />{" "}
        </div>{" "}
