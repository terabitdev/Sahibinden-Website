...
export default function ZerovehicleworldelectricvehicleRowuntitleddesi() {
  const [searchBarValue457, setSearchBarValue457] = React.useState("");
  return (
    <div className="flex items-center gap-[50px] self-stretch md:flex-col">
      ...
      <div className="flex flex-1 items-center justify-between gap-5 md:flex-col md:self-stretch md:px-5">
        ...
        <Input
          ...
          value={searchBarValue457}
          onChange={(e) => setSearchBarValue457(e.target.value)}
          suffix={
            searchBarValue457?.length > 0 ? (
              <CloseSVG onClick={() => setSearchBarValue457("")} />
            ) : null
          }
