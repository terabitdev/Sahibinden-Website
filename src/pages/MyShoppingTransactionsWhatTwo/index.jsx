...
import MyshoppingtransactionswhattwoColumn from "./MyshoppingtransactionswhattwoColumn";
...
const table4Data = [
  ...
  },
  {
    ...
    rowproducttitle: "House",
    row: "M.Umer",
    threeMillionTwoHundredTwoThousandTwentyFive: "By price (Lowest First)",
    Two: "3/20/2025",
  },
  {
    rowproductno: "992170042",
...
export default function MyShoppingTransactionsWhatTwoPage() {
  const table4Columns = React.useMemo(() => {
    const table4ColumnHelper = createColumnHelper();
    return [
      table4ColumnHelper.accessor("rowproductno", {
        cell: (info) => (
      ...
      table4ColumnHelper.accessor("rowproducttitle", {
        cell: (info) => (
      ...
      table4ColumnHelper.accessor("row", {
        cell: (info) => (
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between gap-5 sm:flex-col">
              ...
              <div className="relative h-[44px] w-[68%] content-center md:h-auto sm:w-full">
                {" "}
                <div className="ml-[68px] flex w-[64%] items-center justify-between gap-5 md:ml-0">
                  {" "}
          ...
          <div className="flex-1">
            ...
            <div className="mt-2 flex items-start justify-between gap-5 sm:flex-col">
              ...
              <div className="relative h-[44px] w-[68%] self-center md:h-auto sm:w-full">
                {" "}
                <div className="mr-[50px] flex w-[74%] items-center justify-between gap-5 md:mr-0">
                  {" "}
                  <div className="h-[30px] w-px bg-white" />{" "}
                  <Text
                    as="p"
    ...
    <>
      ...
      <div className="flex w-full flex-col gap-[92px] bg-white md:gap-[69px] sm:gap-[46px]">
        ...
        <div className="flex flex-col items-center gap-[100px] md:gap-[75px] sm:gap-[50px]">
                ...
                >
                  ...
                  {[...Array(17)].map((_, i) => (
                    <AccordionItem uuid={i} key={`expandablelistm${i}`}>
                      {" "}
                      <div className="flex-1 border border-solid border-primary_colors-900 bg-white p-4">
                        {" "}
                        <AccordionItemPanel>
                          {" "}
                          <div className="flex">
                            ...
                            <Text
                              size="textlg"
                              as="p"
                              className="w-[44%] text-[15px] font-normal capitalize leading-[22px] !text-primary_colors-900"
                            >
                              {" "}
                              What i will ship{" "}
                            </Text>{" "}
                ...
                <div className="flex flex-1 flex-col gap-[30px] md:self-stretch">
                  ...
                  <div className="flex flex-col items-start gap-5">
                    ...
                    <Input
                      ...
                      shape="round"
                      name="groupthirtyone"
                      placeholder={`Among the items i will ship are the advertisement no.`}
                  ...
                  <div className="relative h-[694px] content-center md:h-auto">
                    ...
                    <div className="flex flex-1 flex-col gap-5">
                      ...
                      <div className="flex items-center justify-between gap-5 rounded-[10px] border border-solid border-primary_colors-900 bg-white px-2.5 py-3.5 md:flex-col">
                        ...
                        >
                          {" "}
                          You do not have any products to ship.{" "}
                        </Text>{" "}
                        <SelectBox
                          size="xs"
                          shape="round"
          ...
          <MyshoppingtransactionswhattwoColumn />{" "}
        </div>{" "}
