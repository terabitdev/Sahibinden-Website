...
import WhilesellingvehiclesalesguideoneColumn from "./WhilesellingvehiclesalesguideoneColumn";
import WhilesellingvehiclesalesguideoneRow from "./WhilesellingvehiclesalesguideoneRow";
import React from "react";
export default function WhileSellingVehicleSalesGuideOnePage() {
  const [searchBarValue92, setSearchBarValue92] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[82px] bg-white md:gap-[61px] sm:gap-[41px]">
          ...
          <div className="flex items-center justify-center gap-[50px] self-stretch md:flex-col">
            ...
            <div className="flex w-[86%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue92}
                onChange={(e) => setSearchBarValue92(e.target.value)}
                suffix={
                  searchBarValue92?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue92("")} />
                  ) : null
                }
        ...
        <div className="flex flex-col gap-[98px] md:gap-[73px] sm:gap-[49px]">
          {" "}
          <WhilesellingvehiclesalesguideoneRow />{" "}
          <WhilesellingvehiclesalesguideoneColumn />{" "}
        </div>{" "}
