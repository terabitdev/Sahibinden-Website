...
import WhilebuyingmypastqueriesColumnTwo from "./WhilebuyingmypastqueriesColumnTwo";
import WhilebuyingmypastqueriesRow from "./WhilebuyingmypastqueriesRow";
import React from "react";
export default function WhileBuyingMyPastQueriesPage() {
    ...
    <>
      ...
      <div className="flex w-full flex-col gap-[92px] bg-white md:gap-[69px] sm:gap-[46px]">
          ...
          <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
            ...
            <div className="flex w-[46%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                onChange={(e) => setSearchBarValue24(e.target.value)}
                suffix={
                  searchBarValue24?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue24("")} />
                  ) : null
                }
        ...
        <div className="flex flex-col gap-[94px] md:gap-[70px] sm:gap-[47px]">
          {" "}
          <WhilebuyingmypastqueriesRow /> <WhilebuyingmypastqueriesColumnTwo />{" "}
        </div>{" "}
