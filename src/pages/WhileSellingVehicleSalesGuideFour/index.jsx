...
import WhilesellingvehiclesalesguidefourColumn from "./WhilesellingvehiclesalesguidefourColumn";
import WhilesellingvehiclesalesguidefourColumnTwo from "./WhilesellingvehiclesalesguidefourColumnTwo";
import React from "react";
export default function WhileSellingVehicleSalesGuideFourPage() {
  const [searchBarValue95, setSearchBarValue95] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[92px] bg-white md:gap-[69px] sm:gap-[46px]">
          ...
          <div className="flex items-center justify-center gap-[50px] self-stretch md:flex-col">
            ...
            <div className="flex w-[86%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue95}
                onChange={(e) => setSearchBarValue95(e.target.value)}
                suffix={
                  searchBarValue95?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue95("")} />
                  ) : null
                }
        ...
        <div className="flex flex-col gap-[30px]">
          {" "}
          <WhilesellingvehiclesalesguidefourColumn />{" "}
          <WhilesellingvehiclesalesguidefourColumnTwo />{" "}
        </div>{" "}
