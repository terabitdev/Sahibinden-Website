...
const accordionData = [
  { whatsinthe2: "What&#39;s in the Real Estate Index?" },
  {
    whatsinthe2:
  ...
  { whatsinthe2: "Are the data in the Real Estate Index up-to-date?" },
  { whatsinthe2: "How many locations can I compare in the Property Index?" },
  {
    whatsinthe2:
      "Can I create as many indices as I want in the Real Estate Index?",
  },
  { whatsinthe2: "What is the Amortization Period?" },
  { whatsinthe2: "How to prepare Demographic Information?" },
  { whatsinthe2: "How is the 6 Month Forecast data generated?" },
];
export default function RealestateindexwhensellingoneColumnSix() {
  return (
