...
import ZerovehicleworldnewvehicleColumn from "./ZerovehicleworldnewvehicleColumn";
import ZerovehicleworldnewvehicleColumnOne from "./ZerovehicleworldnewvehicleColumnOne";
import React from "react";
export default function ZeroVehicleWorldNewVehiclePage() {
  const [searchBarValue168, setSearchBarValue168] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="w-full bg-white">
          ...
          <div className="flex items-center justify-center gap-[50px] self-stretch md:flex-col">
            ...
            <div className="flex w-[86%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue168}
                onChange={(e) => setSearchBarValue168(e.target.value)}
                suffix={
                  searchBarValue168?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue168("")} />
                  ) : null
                }
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-8">
          ...
          <div className="flex flex-col gap-[100px] self-stretch md:gap-[75px] sm:gap-[50px]">
            ...
            <ZerovehicleworldnewvehicleColumnOne />{" "}
          </div>{" "}
        </div>{" "}
