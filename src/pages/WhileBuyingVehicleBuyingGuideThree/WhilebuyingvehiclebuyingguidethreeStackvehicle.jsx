...
const data = [
  {
    ...
    description: (
      <>
        {" "}
        When you contact the seller and see the vehicle on site; <br /> Inquiry
        into the damage to the vehicle, <br /> You should take a test drive with
        the vehicle, <br /> It is recommended that you check the vehicle&#39;s{" "}
        <br /> registration information and chassis information.{" "}
      </>
    ),
  ...
  {
    check: "Prepare for Notary Procedures",
    description: (
      <>
        {" "}
        When you contact the seller and see the vehicle on site; <br /> Inquiry
...
const data1 = [
  {
    ...
    descriptionText: (
      <>
        {" "}
        You can learn the estimated market value of the <br /> vehicle you are
        considering purchasing through <br /> the Vehicle Valuation service.{" "}
      </>
    ),
...
export default function WhilebuyingvehiclebuyingguidethreeStackvehicle() {
  return (
