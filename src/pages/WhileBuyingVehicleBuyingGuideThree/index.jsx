...
import WhilebuyingvehiclebuyingguidethreeColumnThree from "./WhilebuyingvehiclebuyingguidethreeColumnThree";
import WhilebuyingvehiclebuyingguidethreeStackvehicle from "./WhilebuyingvehiclebuyingguidethreeStackvehicle";
import React from "react";
export default function WhileBuyingVehicleBuyingGuideThreePage() {
    ...
    <>
      ...
      <div className="w-full bg-white">
              ...
              <Input
                ...
                suffix={
                  searchBarValue34?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue34("")} />
                  ) : null
                }
        ...
        <div className="mt-[54px] flex flex-col gap-[218px] md:gap-[163px] sm:gap-[109px]">
          {" "}
          <WhilebuyingvehiclebuyingguidethreeStackvehicle />{" "}
          <WhilebuyingvehiclebuyingguidethreeColumnThree />{" "}
        </div>
