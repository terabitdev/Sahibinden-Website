export default function MyAccountElectronicMessagePage() {
  return (
    <>
      {" "}
      <Helmet>
          ...
          <div className="flex flex-col gap-[100px] md:gap-[75px] sm:gap-[50px]">
            ...
            <div className="flex items-start gap-[30px] md:flex-col">
              ...
              <div className="flex w-[22%] flex-col items-center self-center md:w-full">
                {" "}
                <div className="flex items-center justify-center gap-3.5 self-stretch border border-solid border-primary_colors-900 bg-white p-2.5">
                  {" "}
                  <a
                ...
                <div className="flex items-end justify-between gap-5 self-stretch border border-solid border-primary_colors-900 bg-primary_colors-900 px-5 py-2.5">
                  {" "}
                  <Text
                    size="text2xl"
                    as="p"
                ...
                <div className="flex self-stretch border-[0.5px] border-solid border-primary_colors-900 bg-white px-5 py-4">
                  {" "}
                  <a
                    href="https://www.youtube.com/embed/bv8Fxk0sz7I"
                    target="_blank"
              ...
              <div className="flex flex-1 flex-col items-start md:self-stretch">
                ...
                <div className="mt-2.5 flex items-start self-stretch bg-white p-6 shadow-xs md:flex-col sm:p-5">
                  {" "}
                  <div className="flex w-[44%] flex-col items-start gap-5 self-center md:w-full">
                    {" "}
                    <Heading
                      size="headingmd"
                      as="h2"
                    ...
                    <Heading
                      size="text3xl"
                      as="h3"
                      className="text-[20px] font-normal leading-[30px] !text-black-0"
                    >
                      {" "}
                      <>
                        {" "}
                        I want to be informed about special <br /> campaigns,
                        offers and promotions.{" "}
                      </>{" "}
                    </Heading>{" "}
                  </div>
                  <div className="mt-1.5 flex flex-1 flex-col gap-[22px] md:self-stretch">
                    {" "}
                    <div className="flex flex-wrap justify-end gap-[51px] md:gap-5">
                      {" "}
                      <Heading
                        size="headingmd"
                        as="h4"
                    ...
                    <div className="mx-6 flex justify-end gap-[50px] md:mx-0 sm:flex-col">
                      {" "}
                      <Switch
                        value={true}
