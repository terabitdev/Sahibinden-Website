...
export default function AutoexpertiseoneColumnOne() {
  return (
        ...
        <div className="flex gap-[30px] self-stretch md:flex-col">
          ...
          <ServiceDescription
            ...
            descriptionText={
              <>
                {" "}
                Choose from our expert packages and have a comprehensive <br />{" "}
                expert assessment done at an affordable price.{" "}
              </>
            }
          />{" "}
          <ServiceDescription
