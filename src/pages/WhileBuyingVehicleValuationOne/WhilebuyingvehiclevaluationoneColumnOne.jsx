...
const accordionData = [
  { whatisvehicle1: "What is Vehicle Valuation?" },
  { whatisvehicle1: "In which categories is it available?" },
  { whatisvehicle1: "Who can use it?" },
  { whatisvehicle1: "Can I also use Vehicle Valuation via the mobile app?" },
  { whatisvehicle1: "How is the value of the vehicle calculated?" },
  { whatisvehicle1: "Can I use this service when posting an ad?" },
  {
    whatisvehicle1:
      "I inquired about my vehicle but I could not find out its value. Why?",
  },
];
export default function WhilebuyingvehiclevaluationoneColumnOne() {
  return (
