...
import WhilesellingautodictionaryColumn from "./WhilesellingautodictionaryColumn";
import WhilesellingautodictionaryColumnOne from "./WhilesellingautodictionaryColumnOne";
import WhilesellingautodictionaryColumnThree from "./WhilesellingautodictionaryColumnThree";
import React from "react";
export default function WhileSellingAutoDictionaryPage() {
  const [searchBarValue91, setSearchBarValue91] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="w-full bg-white">
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="flex items-center justify-center gap-[50px] self-stretch md:flex-col">
              ...
              <div className="flex w-[86%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
                ...
                <Input
                  ...
                  value={searchBarValue91}
                  onChange={(e) => setSearchBarValue91(e.target.value)}
                  suffix={
                    searchBarValue91?.length > 0 ? (
                      <CloseSVG onClick={() => setSearchBarValue91("")} />
                    ) : null
                  }
          ...
          <div className="container-sm mt-1 flex flex-col items-start pl-[460px] pr-14 md:px-5">
            {" "}
          ...
          <WhilesellingautodictionaryColumn />{" "}
        </div>{" "}
        <WhilesellingautodictionaryColumnOne />{" "}
        <WhilesellingautodictionaryColumnThree />{" "}
