...
export default function ZerovehicleworldRow() {
  const [searchBarValue442, setSearchBarValue442] = React.useState("");
  return (
    <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
      ...
      <div className="flex w-[46%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
        ...
        <Input
          ...
          value={searchBarValue442}
          onChange={(e) => setSearchBarValue442(e.target.value)}
          suffix={
            searchBarValue442?.length > 0 ? (
              <CloseSVG onClick={() => setSearchBarValue442("")} />
            ) : null
          }
