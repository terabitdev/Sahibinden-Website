...
import RealestateexpertiseafterleasethreeColumn from "./RealestateexpertiseafterleasethreeColumn";
import RealestateexpertiseafterleasethreeColumnTwo from "./RealestateexpertiseafterleasethreeColumnTwo";
import React from "react";
export default function RealEstateExpertiseAfterLeaseThreePage() {
  const [searchBarValue166, setSearchBarValue166] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[94px] bg-white md:gap-[70px] sm:gap-[47px]">
          ...
          <div className="flex items-center justify-center gap-[50px] self-stretch md:flex-col">
            ...
            <div className="flex w-[86%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue166}
                onChange={(e) => setSearchBarValue166(e.target.value)}
                suffix={
                  searchBarValue166?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue166("")} />
                  ) : null
                }
        ...
        <div className="flex flex-col gap-[100px] md:gap-[75px] sm:gap-[50px]">
          {" "}
          <RealestateexpertiseafterleasethreeColumn />{" "}
          <RealestateexpertiseafterleasethreeColumnTwo />{" "}
        </div>{" "}
