...
export default function RealestateexpertiseafterleasethreeColumnTwo() {
  return (
        ...
        <div className="flex flex-col gap-3 self-stretch rounded-[30px] bg-white p-[38px] sm:p-5">
          ...
          <div className="flex flex-col items-center">
            ...
            <TextArea
              ...
              className="self-stretch rounded-[10px] px-[34px] font-medium capitalize text-text_light sm:px-5 sm:pt-5"
            />{" "}
