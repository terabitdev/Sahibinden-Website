...
import WhilebuyingvehicledamageinquiryColumnOne from "./WhilebuyingvehicledamageinquiryColumnOne";
import WhilebuyingvehicledamageinquiryColumnThree from "./WhilebuyingvehicledamageinquiryColumnThree";
import WhilebuyingvehicledamageinquiryColumnTwo from "./WhilebuyingvehicledamageinquiryColumnTwo";
import WhilebuyingvehicledamageinquiryRowTwo from "./WhilebuyingvehicledamageinquiryRowTwo";
import React from "react";
export default function WhileBuyingVehicleDamageInquiryPage() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-white">
          ...
          <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
            ...
            <div className="flex w-[46%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                onChange={(e) => setSearchBarValue23(e.target.value)}
                suffix={
                  searchBarValue23?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue23("")} />
                  ) : null
                }
        ...
        <div className="mt-1 flex flex-col items-center gap-[60px] sm:gap-[30px]">
          {" "}
          <div className="container-sm flex flex-col items-start pl-[328px] pr-14 md:px-5">
            ...
            <div className="flex w-[20%] flex-col items-center rounded-lg md:w-full">
              ...
              <Text
                as="p"
                className="bg-white py-3 pl-4 !font-montserrat text-[16px] font-normal !text-primary_colors-900"
              >
                {" "}
          ...
          <div className="self-stretch">
            {" "}
            <WhilebuyingvehicledamageinquiryRowTwo />{" "}
            <WhilebuyingvehicledamageinquiryColumnOne />{" "}
            <WhilebuyingvehicledamageinquiryColumnTwo />{" "}
            <WhilebuyingvehicledamageinquiryColumnThree />{" "}
          </div>{" "}
        </div>{" "}
