...
import RealestateexpertisepropertyColumn from "./RealestateexpertisepropertyColumn";
import RealestateexpertisepropertyColumnTwo from "./RealestateexpertisepropertyColumnTwo";
import React from "react";
export default function RealEstateExpertisePropertyPage() {
    ...
    <>
      ...
      <div className="flex w-full flex-col gap-[92px] bg-white md:gap-[69px] sm:gap-[46px]">
          ...
          <div className="flex items-center justify-center gap-[50px] self-stretch md:flex-col">
            ...
            <div className="flex w-[86%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                onChange={(e) => setSearchBarValue35(e.target.value)}
                suffix={
        ...
        <div className="flex flex-col gap-[100px] md:gap-[75px] sm:gap-[50px]">
          {" "}
          <RealestateexpertisepropertyColumn />{" "}
          <RealestateexpertisepropertyColumnTwo />{" "}
        </div>{" "}
