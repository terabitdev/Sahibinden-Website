...
const accordionData = [
  { whatisvehicle2: "What is Vehicle Valuation?" },
  { whatisvehicle2: "In which categories is it available?" },
  { whatisvehicle2: "Who can use it?" },
  { whatisvehicle2: "Can I also use Vehicle Valuation via the mobile app?" },
  { whatisvehicle2: "How is the value of the vehicle calculated?" },
  { whatisvehicle2: "Can I use this service when posting an ad?" },
  {
    whatisvehicle2:
      "I inquired about my vehicle but I could not find out its value. Why?",
  },
];
export default function WhilesellingvehiclevaluationColumnOne() {
  return (
