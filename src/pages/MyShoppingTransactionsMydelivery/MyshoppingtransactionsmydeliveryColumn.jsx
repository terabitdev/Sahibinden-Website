...
export default function MyshoppingtransactionsmydeliveryColumn() {
  return (
    <div className="flex flex-col items-center self-stretch">
      ...
      <div className="container-sm flex flex-col items-start gap-14 px-[34px] md:px-5 sm:gap-7">
        ...
        <div className="mr-2.5 flex flex-col items-center self-stretch rounded-[30px] bg-white p-[38px] md:mr-0 sm:p-5">
          {" "}
