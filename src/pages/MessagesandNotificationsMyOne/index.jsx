...
import MessagesandnotificationsmyoneColumnOne from "./MessagesandnotificationsmyoneColumnOne";
import React from "react";
export default function MessagesandNotificationsMyOnePage() {
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="flex w-full flex-col gap-[92px] bg-white md:gap-[69px] sm:gap-[46px]">
        ...
        <div className="flex flex-col items-center gap-[100px] md:gap-[75px] sm:gap-[50px]">
          ...
          <div className="container-sm md:px-5">
            ...
            <div className="flex items-start gap-[30px] md:flex-col">
              ...
              <div className="flex flex-1 flex-col items-start gap-2.5 self-center md:self-stretch">
                ...
                >
                  {" "}
                  My Product Offers - I am a Seller{" "}
                </Heading>{" "}
                <div className="flex flex-col items-center justify-center gap-5 self-stretch rounded-[10px] bg-white px-14 py-[126px] shadow-xs md:p-5">
                  ...
                  >
                    ...
                    <>
                      {" "}
                      You don&#39;t have any offers yet <br /> Add products you
                      don&#39;t use, evaluate offers from buyers and earn
                      immediately.{" "}
                    </>{" "}
                  </Heading>{" "}
                  <Button
                    ...
                    variant="fill"
                    shape="round"
                    className="min-w-[174px] rounded-[24px] px-[18px] font-medium uppercase"
                  >
                    {" "}
                    Post an ad Now{" "}
                  </Button>{" "}
          ...
          <MessagesandnotificationsmyoneColumnOne />{" "}
        </div>{" "}
