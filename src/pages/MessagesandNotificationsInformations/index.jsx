...
export default function MessagesandNotificationsInformationsPage() {
  return (
    <>
      {" "}
      <Helmet>
              ...
              <div className="flex items-start gap-[30px] md:flex-col">
                ...
                <div className="flex w-[22%] flex-col items-center self-center md:w-full">
                  ...
                  <Input
                    ...
                    className="self-stretch border border-solid border-primary_colors-900 px-2.5"
                  />{" "}
                ...
                <div className="flex flex-1 flex-col items-start gap-2.5 md:self-stretch">
                  ...
                  <Input
                    ...
                    className="self-stretch rounded-[10px] border border-solid border-primary_colors-900 px-3.5 !text-blue_gray-400"
                  />{" "}
                </div>{" "}
              </div>
