...
export default function RealestateexpertisepropertytwoColumn() {
  return (
      ...
      <div className="container-sm md:px-5">
        ...
        >
          ...
          <>
            ...
            sales price in proportion to the defect <br />
            Requesting the seller to repair or fix the deficiency and pay the
            costs. <br /> Replacing the residence with another residence of the
            same characteristics <br /> The consumer can only use one of these
            rights. According to Article 12 of the Consumer Protection Law, if
            the defects in the house are grossly defective or concealed by
            fraud, the 5-year limitation period does not apply. In such cases,
            the period for the consumer to use their rights is unlimited.{" "}
          </>{" "}
        </Heading>{" "}
