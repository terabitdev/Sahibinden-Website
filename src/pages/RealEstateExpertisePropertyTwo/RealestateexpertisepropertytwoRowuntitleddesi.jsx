...
export default function RealestateexpertisepropertytwoRowuntitleddesi() {
  const [searchBarValue399, setSearchBarValue399] = React.useState("");
  return (
    <div className="flex items-center gap-[50px] self-stretch md:flex-col">
      ...
      <div className="flex flex-1 items-center justify-between gap-5 md:flex-col md:self-stretch md:px-5">
        ...
        <Input
          ...
          value={searchBarValue399}
          onChange={(e) => setSearchBarValue399(e.target.value)}
          suffix={
            searchBarValue399?.length > 0 ? (
              <CloseSVG onClick={() => setSearchBarValue399("")} />
            ) : null
          }
