...
import RealestatedictionaryColumn from "./RealestatedictionaryColumn";
import RealestatedictionaryColumnOne from "./RealestatedictionaryColumnOne";
import RealestatedictionaryColumnTwo from "./RealestatedictionaryColumnTwo";
import React from "react";
export default function RealEstateDictionaryPage() {
  const [searchBarValue152, setSearchBarValue152] = React.useState("");
  return (
    <>
      {" "}
      <Helmet>
      ...
      <div className="w-full bg-white">
          ...
          <div className="flex items-center justify-center gap-[50px] self-stretch md:flex-col">
            ...
            <div className="flex w-[86%] items-center justify-between gap-5 md:w-full md:flex-col md:px-5">
              ...
              <Input
                ...
                value={searchBarValue152}
                onChange={(e) => setSearchBarValue152(e.target.value)}
                suffix={
                  searchBarValue152?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue152("")} />
                  ) : null
                }
        ...
        <div className="flex flex-col items-center gap-[62px] sm:gap-[31px]">
          ...
          <div className="self-stretch">
            {" "}
            <RealestatedictionaryColumn /> <RealestatedictionaryColumnOne />{" "}
            <RealestatedictionaryColumnTwo />{" "}
          </div>{" "}
        </div>{" "}
